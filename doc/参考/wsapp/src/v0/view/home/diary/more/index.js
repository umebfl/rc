...
import Diary_more_list from '../../../../component/list/diary_more_list'
...
import {
    INIT_PAGE_NUMBER,
    home_diary_more_init,
    home_diary_more_search,
} from './reducer.js'
...
class More extends Component {
    ...
    init() {
        _fetch({
            ...
            path: DATA_PATH,
            param: {
                wsId: this.props.navigation.state.params.id,
                pageSize: PAGE_SIZE,
            ...
            success: rv => {
                this.props.action.home_diary_more_init(rv)
            },
    ...
    search() {
        _fetch({
            ...
            param: {
                wsId: this.props.navigation.state.params.id,
                pageSize: PAGE_SIZE,
                pageNumber: this.props.diary_more.page_number + 1,
            },
            token: this.props.auth.info.token,
            lang: this.props.i18n.lang,
            success: rv => {
                this.props.action.home_diary_more_search(rv)
            },
            update_state: payload => {
                this.setState({
                    ...this.state,
    ...
    render() {
        ...
        return (
            ...
            <Header
                ...
                center_option={{
                    text: this.props.navigation.state.params.name + t.diary,
                }}/>
